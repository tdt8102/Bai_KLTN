...
<html lang="en">
  ...
  <body>
    ...
    <div class = "item_form1">
        <form method="post" action = "EditPost_function.php?id_cmt=<?php echo $_GET['id_cmt']?>&&post_content=<?php echo $_GET['post_content']?>">
            <div class="container item_form1">
                ...
                <div>
                    ...
                    <input type="text" name="class_id" value = "<?php echo $_GET['class_id']?>" required>
                </div>
        ...
        <script>
                function goToAdminPage() {
                    ...
                    window.location.href = "QuanLyPost.php";
                return false;
                }
            </script>
    </div>
