...
<body>
    ...
    <div class="item_form1">
        <form method="post"
            action="UpdateUser_function.php?id=<?php echo $_GET['id'] ?>&&username=<?php echo $_GET['username'] ?>">
            <div class="container item_form1">
                ...
                <div>
                    <label for="status"><b>Tình trạng tài khoản (1 - khả dụng/ 0 - không khả dụng)</b></label>
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" name="role" value="1" <?php if ($_GET['role'] == 1) {
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" name="role" value="2" <?php if ($_GET['role'] == 2) {
                        echo "checked=checked";
                    } ?>>
                    Giáo viên
                </div>
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" name="role" value="3" <?php if ($_GET['role'] == 3) {
                        echo "checked=checked";
                    } ?>> Ủy
                    quyền Admin
                </div>
