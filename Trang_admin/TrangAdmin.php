                                ...
                                <form method="post" action="ThemUser.php">
                                    <div class="container">
                                        ...
                                        <div>
                                            ...
                                            <input value="<?php echo isset($fullname) ? $fullname : ''; ?>" type="text"
                                                placeholder="Nhập họ và tên" id="fullname" name="fullname" required>
                                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a id="modalActivate" data-toggle="modal" data-target="#ModalJoinClass" href=""
                            class="dropdown-item" href="#">Thêm user</a>
            ...
            <table>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="UpdateUser.php?id=<?php echo $row['user_id']; ?> && username=<?php echo $row['username']; ?> && password=<?php echo $row['password']; ?> && fullname=<?php echo $row['fullname']; ?> && birthdate=<?php echo $row['birthdate']; ?> && email=<?php echo $row['email']; ?> && phone=<?php echo $row['phone']; ?> && role=<?php echo $row['role'] ?> && status=<?php echo $row['status'] ?>"
                                class="btn btn-warning">Update</a>
                            <a href="XoaUser.php?id_delete=<?php echo $row['user_id']; ?> && username=<?php echo $row['username']; ?>"
